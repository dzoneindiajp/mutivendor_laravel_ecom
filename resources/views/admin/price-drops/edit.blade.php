...
<div class="row">
    <div class="col-xl-12">
        <form action="{{route('admin-price-drops.update',$userDetails->id)}}" method="post" enctype="multipart/form-data"
            id="editUserForm">
            @csrf
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-6" id="categoryDropdown" style="display: none;">
                                                ...
                                                <select class="js-example-placeholder-single js-states form-control" multiple="multiple" name="categoryData[]">
                                                    ...
                                                    <option value="{{ $category['id'] }}" {{in_array($category['id'],$price_drop_assigned) ? 'selected' : ''}}>{{ $category['name'] }}</option>
                                                    @empty
