        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a href="{{ route('admin-product-create') }}" class="btn btn-primary mb-3" style="float: right">Add
                        Product</a>
                </div>
            </div>
            <div class="card-body">
                <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ $product->front_image_url }}" height="70px" width="70px"
                                    style="border-radius: 10%"></td>
                            <td>{{ $product->price }}</td>
                            <td>
                                <div class="hstack gap-2 flex-wrap">
                                    <a href="{{ route('admin-product-view',['token' => encrypt($product->id)]) }}"
                                        class="btn btn-info"><i class="ri-eye-line"></i></a>
                                    <a href="{{ route('admin-product-edit',['token' => encrypt($product->id)]) }}"
                                        class="btn btn-info"><i class="ri-edit-line"></i></a>
                                    <form method="POST"
                                        action="{{ route('admin-product-delete',['token' => encrypt($product->id)]) }}">
                                        @csrf
