...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						Add New {{Config('constant.DESIGNATION.DESIGNATION_TITLE')}} </h5>
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						<li class="breadcrumb-item">
							<a href="{{ route('admin-dashboard')}}" class="text-muted">Dashboard</a>
						</li>
						<li class="breadcrumb-item">
							<a href="{{  route('admin-departments.index')}}" class="text-muted">Departments</a>
						</li>
						<li class="breadcrumb-item">
							<a href="{{route('admin-'.$model.'.index',['endesid'=>base64_encode($dep_id)])}}" class="text-muted">{{Config('constant.DESIGNATION.DESIGNATIONS_TITLE')}}</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<div class="d-flex flex-column-fluid">
		<div class=" container ">
			<form action="{{route('admin-'.$model.'.add',['endesid'=>base64_encode($dep_id)])}}" method="post" class=mws-form files=true autocomplete="off">
				@csrf
				<div class="card">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-xl-10">
								<h3 class="mb-10 font-weight-bold text-dark">
									{{Config('constant.DESIGNATION.DESIGNATION_TITLE')}} Information
								</h3>
								<div class="row">
									<div class="col-xl-6">
