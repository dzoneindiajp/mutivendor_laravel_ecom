...
<div class="card custom-card">
    ...
    <form action="{{ route('admin-product-categories-sub-category-update',['token' => encrypt($subCategory->id)]) }}" method="post" id="editsubCategoryForm">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-xl-6">
                    <div class="card-body p-0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="sub_category" name="sub_category"
                                placeholder="Enter Sub Category" value="{{ $subCategory->name }}" onkeyup="editDisplaySlug($(this))">
                            <h6 class="edit-sub-category-slug mt-2"></h6>
                        </div>
                    ...
                    <div class="card-body p-0">
                        <div class="col-xl-12">
                            ...
                            <input type="text" class="form-control" id="meta_title" name="meta_title"
                                placeholder="Meta TItle" value="{{ $subCategory->meta_title }}">
                        </div>
                        <div class="col-xl-12 mt-3">
                            <label for="meta_description" class="form-label">Meta Description</label>
                            <textarea class="form-control" name="meta_description" id="meta_description" cols="30"
                                rows="5">{{ $subCategory->meta_description }}</textarea>
                        </div>
                        <div class="col-xl-12 mt-3">
                            <label for="meta_keywords" class="form-label">Meta Keywords</label>
                            <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                                placeholder="Meta Keywords" value="{{ $subCategory->meta_keywords }}">
                        </div>
                    </div>
                </div>
            </div>
...
{{-- <div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <form action="{{ route('admin-product-categories-sub-category-update',['token' => encrypt($subCategory->id)]) }}"
                    method="post" id="editsubCategoryForm">
                    @csrf
                    <div class="mb-3 select2-error">
                        <label for="category" class="form-label"><span class="text-danger">* </span>Category</label>
                        <select class="js-example-placeholder-single js-states form-control" name="category_id"
