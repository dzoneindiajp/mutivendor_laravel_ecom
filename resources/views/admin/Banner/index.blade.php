                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='{{route("$model.create")}}' class="btn btn-primary"> {{ trans("Add New ") }}{{Config('constants.BANNER.BANNER_TITLE')}}</a>
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        @if (!empty($result->image))
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{isset($result->image)? $result->image:''}}"><img height="50" width="50" src="{{isset($result->image)? $result->image:''}}" />
                                                            </a>
                                                        @endif
                                                    </td>
                                                     <td>
