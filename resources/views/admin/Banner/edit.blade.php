...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		<!--begin::Container-->
		<div class=" container ">
			<form action="{{route('Banner.update',$userDetails->id)}}" method="post" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                @csrf
									...
									<div class="row">
										<div class="col-xl-12">
											<div class="form-group">
												...
												<textarea id="description_{{$language->id}}" name="data[{{$language->id}}][description]" class="form-control form-control-solid form-control-lg  @error('description') is-invalid @enderror" value="{{$multiLanguage[$language->id]['description'] ?? old('description')}}">
												{{$multiLanguage[$language->id]['description'] ?? old('description')}} </textarea>
												...
												<textarea name="data[{{$language->id}}][description]" id="description_{{$language->id}}" class="form-control form-control-solid form-control-lg">{{$multiLanguage[$language->id]['description'] ?? old('description')}}</textarea>
												@endif
											</div>
