            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-2  col-md-6 col-6 ms-auto">
                    <div class="header-setting-option">
                            ...
                            <ul class="settings-list">
                                <li>
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <h5>Hi {{auth()->guard('customer')->user()->name ?? ''}}</h5>
                                            </a>
                                            <span class="email">{{auth()->guard('customer')->user()->email ?? ''}}</span>
                                        </li>
                                        <li style="border-top:1px solid #ccc;"><a href="{{route('front-user.dashboard')}}">My Profile</a></li>
                        ...
                        @php
                            $wishlistCount = \App\Models\Wishlist::where('user_id',auth()->guard('customer')->user()->id)->count();
                        @endphp
                        <div class="settings-top">
                            <a href="{{route('front-user.wishlist')}}">
                                ...
                                <p>Wishlist</p>
                                <span class="cart-notification mainWishlistCounter">{{$wishlistCount ?? 0}}</span>
                            </a>
                        </div>
                        @else
                        <div href="{{route('front-user.login')}}"  class="settings-top">
                            <div onclick="window.open('{{route('front-user.login')}}','_self')"  class="settings-btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z" />
                                </svg>
                                <p >Login</p>
...
<script>
    ...
    var removeFromWishlistUrl = "{{route('front-user.removeFromWishlist')}}";
    var addToWishlistUrl = "{{route('front-user.addToWishlist')}}";
