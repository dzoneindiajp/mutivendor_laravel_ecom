...
{
    public function index(Request $request, $enID = null)
    {
        try {
            if (!empty($enID)) {
                $dep_id = base64_decode($enID);
            }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $alreadyAddedName = Category::where('slug', $slug)->first();
    ...
    public function update(Request $request, $token)
    {
        try {
            ...
            $alreadyAddedName = Category::where('slug', $slug)
